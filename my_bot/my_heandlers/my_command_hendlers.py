...
def send_weather(is_send_message:bool = False):
    global bot
    file_name = "production/my_bot/files/image/weather_image_source.png"
    new_file_name = "production/my_bot/files/image/cut_image.png"
